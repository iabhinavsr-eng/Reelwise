  ...
  return (
    <div className="space-y-6 rounded-xl border bg-card p-6 text-card-foreground">
      <section>
        ...
        <div className="mt-4 rounded-xl bg-muted p-8">
          <p className="text-3xl font-extrabold tracking-tight">
            reel<span className="text-secondary">wise</span>
          </p>
        </div>
        <p className="mt-3 text-sm text-muted-foreground">
          The reference uses a compact text wordmark with the brand name split
          between ink and Reelwise green. No separate logo file was supplied.
        </p>
      </section>
      <section className="space-y-3 border-t pt-5">
        <h2 className="font-semibold">Brand signals</h2>
        <div className="grid gap-3 sm:grid-cols-3">
          {[
            ['Ink', 'Primary actions and essential reading'],
            ['Reelwise green', 'Progress, labels, focus, and selection'],
            ['Soft mint', 'Helpful context and suggested states'],
          ].map(([title, body]) => (
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <section className="rounded-xl border bg-card p-5 text-card-foreground">
          ...
          <Card className="mt-4">
            <CardHeader>
              <CardTitle>Make recording feel more natural</CardTitle>
              <CardDescription>
                A script, a steady pace, and a little room to find your voice.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                <Label htmlFor="overview-name">Script title</Label>
                <Input id="overview-name" placeholder="e.g. Launch announcement" />
              </div>
              <div className="flex items-center gap-2">
                <Switch defaultChecked id="overview-notify" />
                <Label htmlFor="overview-notify">Mirror text for the front camera</Label>
