...
import { ContentGuidelinesPage, MotionGuidelinesPage } from './product-guidelines';
...
export const DESIGN_SYSTEM = {
  title: 'Reelwise Design System',
  description:
    'A calm, creator-first visual language for reading scripts and recording social video.',
} as const;
...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    entries: [
      {
        id: 'brand-wordmark',
        name: 'Wordmark and signals',
        description: 'The text wordmark and recognizable Reelwise color roles.',
        Page: BrandPage,
      },
    ],
  },
  ...
  },
  {
    ...
    entries: [
      {
        id: 'content-voice',
        name: 'Voice and onboarding copy',
        description: 'Reassuring, direct language for setup and recording.',
  ...
  },
  {
    ...
    entries: [
      {
        id: 'motion-progress',
        name: 'Progress and feedback',
        description: 'Short transitions and purposeful loading feedback.',
