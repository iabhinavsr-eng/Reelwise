# Migrating web UI to Reelwise Design System

Read `artifacts/reelwise/docs/AGENTS.md` and
`artifacts/reelwise/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/reelwise/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/reelwise/lib/utils`
- `@/hooks/use-toast` → `@workspace/reelwise/hooks/use-toast`
