# Consuming Reelwise Design System in Expo apps

Read `artifacts/reelwise/docs/AGENTS.md` first. React Native does
...
`artifacts/reelwise/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/reelwise/tokens";
...
```tsx
import { nativeTheme } from "@workspace/reelwise/lib/native-theme";
import { useColors } from "@workspace/reelwise/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/reelwise/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/reelwise/components/native/badge";
import { Button } from "@workspace/reelwise/components/native/button";
import { Card } from "@workspace/reelwise/components/native/card";
```
...
Import and render
`@workspace/reelwise/components/native/button`, then run Expo
